...
--
-- Servidor: localhost
-- Tiempo de generación: 10-09-2024 a las 04:56:08
...
(2, 'Consultorio 2 - Cardiología', 'Area con mural de un corazón', 'Planta baja a mano izquierda, a lado de Farmacia', 0),
(3, 'Consultorio 3 - Medicina Familiar', 'Area con ventanas grandes y grises', 'Segunda planta alta, girando a la izquierda de la salida del ascensor', 1),
...
(6, 'Consultorio 6', 'Espacio con muebles color crema', 'Tercer piso a mano derecha', 0),
...
(15, 'consultorio test 2024-08-04', 'paredes azules', 'cuarto piso', 1);
...
(1, 'Cuidado médico de niños y adolescentes.', 0, '2024-06-01 00:00:00', '2024-08-31 22:20:14', 'Pediatría', 1),
...
(3, 'Enfermedades del corazón y del sistema circulatorio.', 0, '2024-07-01 00:00:00', '2024-07-01 00:00:00', 'Cardiología', 1),
...
(27, 'HHHH', 2, '2024-07-28 16:54:24', '2024-08-31 21:58:40', 'PEDIATRIA 1', 1);
...
INSERT INTO `Medico` (`id`, `estado`, `persona_id`) VALUES
(2, 1, 26),
(3, 1, 27),
(4, 1, 15),
(6, 1, 32),
...
(52, '1102020202', 'JARAMILLO ROSALES', 'LOJA ECUADOR', 'GONZANAMA Y SUCRE', 'chiillo@gmail.com', '1980-09-20', 'ROCIO DEL CARMEN', 'FEMENINO', '0987654321');
...
(47, 52, '$2a$10$0PvPg0WvSqEj0IvbuzwZD.i4pbA0Mj967X95Ct9XNBJr.3zPKm1oS', 'chiillo', 1);
